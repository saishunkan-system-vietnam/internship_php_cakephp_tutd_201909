    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="title_right">
                <form action="<?php echo $this->Url->build(['controller'=>'About','action'=>'search'])?>" method="get">
        ...
        <div class="x_content">
            <div class="table-responsive">
                <form method="post">
                    <p>
                        <button type="submit"
                                formaction="<?php echo $this->Url->build(['controller' => 'About', 'action' => 'deleteselected']); ?>"
                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    foreach ($about as $about):
                        ...
                        <tr class="even pointer">
                            ...
                            <td class=""><?php echo $about->id; ?></td>
                            <td class=""><?php echo $about->title; ?></td>
                            <td class=""><?php echo $about->content; ?></i></td>
