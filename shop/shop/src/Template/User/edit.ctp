                        ...
                        <form class="form-horizontal form-label-left" novalidate method="POST"  enctype="multipart/form-data"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="username" class="form-control col-md-7 col-xs-12"
                                           ...
                                           required="required" type="text" value="<?php if (isset($user->username)) echo $user->username;  ?>" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="email" name="email" required="required"
                                           class="form-control col-md-7 col-xs-12" placeholder="Nhập email của bạn "  value="<?php if (isset($user->email)) echo $user->email;  ?>" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="password" type="password" name="password"
                                           ...
                                           placeholder="Nhập mật khẩu của bạn "  value="<?php if (isset($user->password)) echo $user->password;  ?>" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" id="telephone" name="phone" required="required"
                                           placeholder="Nhập số điện thoại c " class="form-control col-md-7 col-xs-12"  value="<?php if (isset($user->phone)) echo $user->phone;  ?>" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12"
                                           ...
                                           required="required" type="text"  value="<?php if (isset($user->addr)) echo $user->addr;  ?>" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="<?= $user->image; ?>" style="height: 70px;width: 70px">
