    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="title_right">
                <form action="<?php echo $this->Url->build(['controller' => 'Payment', 'action' => 'search']) ?>"
                      method="get">
                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    foreach ($pay as $pay):
                        ...
                        <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $pay->id; ?></td>
                            <td class=" "><?php echo $pay->link; ?></td>
                            <td><img src="<?php echo $pay->image; ?>" style="width: 60px;height: 60px"></td>
                            <td class="">
                                <?php if ($pay->status == 0): ?>
                            ...
                            <td class=" last">
                                <a href="/admin/payment/edit/<?= $pay->id ?>">Edit | </a>
                                <a href="/admin/payment/delete/<?= $pay->id ?>"
