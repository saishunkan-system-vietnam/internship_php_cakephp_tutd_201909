    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="title_right">
                <form action="<?php echo $this->Url->build(['controller'=>'Shopon','action'=>'search'])?>" method="get">
        ...
        <div class="x_content">
            <div class="table-responsive">
                <form method="post">
                    <p>
                        <button type="submit"
                                formaction="<?php echo $this->Url->build(['controller' => 'Shopon', 'action' => 'deleteselected']); ?>"
                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    <tr class="headings">
                        ...
                        <th class="column-title">LinkFb</th>
                        <th class="column-title">LinkYoutube</th>
                        <th class="column-title">Linkzalo</th>
                    ...
                    <tbody>
                    <?php
                    foreach ($shopon as $shopon):
                        ?>
                        <tr class="even pointer">
                            <td class="a-center ">
                                <input type="checkbox" class="flat selectbox" name="ids[]"
                                       value="<?php echo $shopon->id ?>">
                            </td>
                            <td class=""><?php echo $shopon->id; ?></td>
                            <td class=""><?php echo $shopon->linkfb; ?></td>
                            <td class=""><?php echo $shopon->linkyou; ?></i></td>
                            <td class=""><?php echo $shopon->linkzalo; ?></i></td>
                            <td><img src="<?php echo $shopon->image; ?>" style="width: 60px;height: 60px"></td>
                            <td class="">
                                <?php if ($shopon->status == 0): ?>
