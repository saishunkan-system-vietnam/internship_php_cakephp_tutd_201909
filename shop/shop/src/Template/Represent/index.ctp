    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="title_right">
                <form action="<?php echo $this->Url->build(['controller' => 'Represent', 'action' => 'search']) ?>"
                      method="get">
        ...
        <div class="x_content">
            <div class="table-responsive">
                <form method="post">
                    <p>
                        <button type="submit"
                                formaction="<?php echo $this->Url->build(['controller' => 'Represent', 'action' => 'deleteselected']); ?>"
                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    <tbody>
                    <?php
                    foreach ($represent as $represent):
                        ?>
                        <tr class="even pointer">
                            <td class="a-center ">
                                <input type="checkbox" class="flat selectbox" name="ids[]"
                                       value="<?php echo $represent->id ?>">
                            </td>
                            <td class=""><?php echo $represent->id; ?></td>
                            <td class=""><?php echo $represent->name; ?></td>
                            <td><img src="<?php echo $represent->image; ?>" style="width: 60px;height: 60px"></td>
                            <td class="">
                                <?php if ($represent->status == 0): ?>
                            ...
                            <td class=" last">
                                <a href="/admin/represent/edit/<?= $represent->id ?>" class="badge badge-success"
                                   style="background-color: #22dd99">Edit </a>
                                <a href="/admin/represent/delete/<?= $represent->id ?>"
