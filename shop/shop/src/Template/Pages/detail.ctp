                        ...
                        <ul class="slides">
                            <li data-thumb="<?php echo $products->image ?>">
                                <div class="thumb-image">
                                    <img src="<?php echo $products['image'] ?>" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                        </ul>
                        ...
                        <div class="men-thumb-item">
                            ...
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                                    <a href="/pages/detail/<?= $relate['id'] ?>" class="link-product-add-cart">Quick View</a>
                                </div>
                            </div>
                        </div>
                        <!-- card body -->
                        <div class="card-body  py-3 px-2">
                            <h5 class="card-title text-capitalize" style="font-weight: bold"><?php echo $relate['product_name']?></h5>
