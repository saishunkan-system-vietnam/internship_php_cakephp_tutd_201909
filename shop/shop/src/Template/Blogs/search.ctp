    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="title_right">
                <form action="<?php echo $this->Url->build(['controller' => 'Blogs', 'action' => 'search']) ?>"
                      method="get">
        ...
        <div class="x_content">
            <div class="table-responsive">
                <form method="post">
                    <p>
                        <button type="submit"
                                formaction="<?php echo $this->Url->build(['controller' => 'Blogs', 'action' => 'deleteselected']); ?>"
                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    foreach ($blogs as $blogs):
                        ...
                        <tr class="even pointer">
                            ...
                            <td class=""><?php echo $blogs->id; ?></td>
                            <td class=""><?php echo $blogs->title; ?></td>
                            <td class=""><?php echo $blogs->description; ?></i></td>
                            <td class=""><?php echo $blogs->content; ?></i></td>
                            <td><img src="<?php echo $blogs->image; ?>" style="width: 60px;height: 60px"></td>
                            <td class=" last">
                                <a href="/admin/blogs/edit/<?= $blogs->id ?>" class="badge badge-success"
